...
\begin{table*}[htbp]
	...
	\scalebox{1}{%
		\begin{tabular}{ lp{1.8cm}p{3cm}p{3.3cm}p{1cm}p{2.5cm}p{2.5cm}l} 
			...
			\cite{huang2019deep} & Wireless-powered MEC & Computation offloading and resource allocations & Maximize computation rate & MIP & DQN & \\\midrule
			\cite{Bolourian-WCL24} & Wireless-powered MEC & Computation offloading & Minimize drop rate and energy consumption. & MDP  & Deep Q-Learning & \\\midrule
			...
			\cite{sun2024hierarchical} & MEC & Computation offloading and service caching & Minimize average service delay & MDP & hierarchical DRL & \\\midrule
			...
			\cite{liu2021learn} & MEC & Resource allocation and computation offloading & Minimize execution cost & POMDP & MADRL & \\\midrule
			\cite{zhou2021deep} & MEC & Resource allocation and computation offloading & Minimize energy consumption & MDP & DDQN & \\\midrule
			\cite{gao2022large} & heterogeneous MEC & Decentralized computation offloading & Optimize system cost and completion rates & MDP & Multi-agent DDPG & \\\midrule
			\cite{gong2022edge} & MEC-based IIoT & Resource allocation and computation offloading & Minimize task computation delay and energy consumption & MDP & DRL & \\\midrule
			\cite{liao2023online} & MEC & Online computation offloading & Minimize computation delay and energy consumption & MDP & DDQN & \\\midrule
